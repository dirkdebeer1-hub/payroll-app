          ...
          {showCompanyControls ? (
            <div className="flex flex-col gap-0.5">
              <div className="flex items-center gap-0.5 flex-wrap">
                <Button
                  ...
                  className="bg-[#465193] text-white hover:bg-[#384080] text-xs font-bold px-3"
                ...
                <div className="flex items-center gap-0 border border-gray-300 overflow-hidden">
                  ...
                  <Button
                    ...
                    className={`text-xs font-bold px-3 border-l border-gray-300 ${
            ...
            <div className="flex items-center gap-0.5 flex-wrap">
              <Button
                ...
                className="text-gray-600 hover:text-gray-800 text-xs font-bold px-3"
