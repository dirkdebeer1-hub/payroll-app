          ...
          {!showForm ? (
            <>
              <Button
                ...
                size="sm"
                className="bg-[#465193] text-white hover:bg-[#384080] text-xs font-bold px-4 py-2"
              ...
              <Input
                ...
                className="w-48 text-xs font-bold bg-white border-gray-300"
            ...
            <>
              <Button
                ...
                className="text-gray-600 hover:text-gray-800 text-xs font-bold px-4 py-2"
        ...
        {!showForm && (
          <div className="flex items-center gap-0 border border-gray-300 overflow-hidden">
            <Button
              ...
              className={`text-xs font-bold px-3 py-2 h-auto ${
            ...
            <Button
              ...
              className={`text-xs font-bold px-3 py-2 h-auto border-l border-gray-300 ${
